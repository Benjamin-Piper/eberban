...
PU_clause = expr:(spaces? PU) {return _node("PU_clause", expr);} // UNUSED
 //
...
CU_clause = expr:(spaces? CU) {return _node("CU_clause", expr);} // UNUSED
...
CU = expr:(&particle_word (c &u vhowels) &post_word) {return _node("CU", expr);}
